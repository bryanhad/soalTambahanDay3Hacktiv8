...
const compareString = (w1:string, w2:string):string => {
    let msg
...
const compareNumber = (n1:number, n2:number):string => {
...
*/
const compareBoolean = (bool1:boolean, bool2:boolean):string => {
...
const countVokal = (phrase:string, vokal:string):number => {
    let total = 0
